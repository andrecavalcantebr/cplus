...
/*
 * FILE: test_golden_valid.c
 * DESC.: golden test — valid C23 input produces identical output (identity transform)
...
int main(void) {
    ...
    char output_template[] = "/tmp/cplus_golden_valid_XXXXXX";
