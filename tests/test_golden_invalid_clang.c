...
/*
 * FILE: test_golden_invalid_clang.c
 * DESC.: golden test — invalid C23 input causes rc=1 and no output file (clang validator)
...
int main(void) {
    ...
    char output_template[] = "/tmp/cplus_golden_invalid_clang_XXXXXX";
